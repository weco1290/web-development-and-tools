...
import { makeTodoList } from './todos.js';
...
// I've deliberately not included controllers as we had previously
// so this is a bad sample to copy
...
app.post('/api/session', (req, res) => {
  ...
  if(!existingUserData) {
    users.addUserData(username, makeTodoList());
  }
