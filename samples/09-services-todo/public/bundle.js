...
function generateTodosHtml(state) {
  var todosHtml = Object.values(state.todos).map(function (todo) {
    ...
    return "\n      <li class=\"todo\">\n        <label\n          for=\"todo__toggle--".concat(todo.id, "\"\n        >\n          <input\n            id=\"todo__toggle--").concat(todo.id, "\"\n            class=\"todo__toggle\"\n            data-id=\"").concat(todo.id, "\"\n            type=\"checkbox\"\n            ").concat(todo.done ? "checked" : "", "\n          >\n          <span\n            data-id=\"").concat(todo.id, "\"\n            class=\"todo__toggle todo__text ").concat(isDoneClass, " ").concat(isAddedClass, " \"\n          >\n            ").concat(todo.task, "\n          </span>\n        </label>\n        <button\n          data-id=\"").concat(todo.id, "\"\n          class=\"todo__delete\"\n        >\n          &#10060;\n        </button>\n      </li>\n      ");
  }).join('');
  return todosHtml ? "<ul class=\"todos\">".concat(todosHtml, "</ul>") : "<p>No Todo Items yet, add one!</p>";
}
...
var state = {
  ...
  username: '',
  lastAddedTodoId: '',
  // Used for fancy CSS on newest item
  error: ''
};
